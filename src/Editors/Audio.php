...
/**
 * The below code my seems illogical, as composer can handle it
 * but I'm adding it to bypass static-analysis(phpstan) error reporting :)
 */
if (file_exists(dirname(__FILE__, 5) . '/james-heinrich/getid3/getid3/getid3.php')) {
...
class Audio
{
     ...
     * @return $this
     */
    public function setTag($name, string $value = ''): Audio
    {
        if (is_array($name)) {
            $this->tagData = array_merge($this->tagData, $name);
            return $this;
        }
     ...
     * @return $this
     */
    public function setOption($name, string $value = ''): Audio
    {
        if (is_array($name)) {
            $this->tagData = array_merge($this->options, $name);
            return $this;
        }
     ...
     * @return $this
     */
    public function setLyric(string $lyric): Audio
    {
